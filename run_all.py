...
parser.add_argument('--subject-type', default='cross', type=str, help='Type of subjects (cross or intra)')
...
os.system(f"python pkl_to_mat.py --session-length {session_length}")
...
os.system(f"python running_norm.py --n-vids {n_vids} --session-length {session_length}")
