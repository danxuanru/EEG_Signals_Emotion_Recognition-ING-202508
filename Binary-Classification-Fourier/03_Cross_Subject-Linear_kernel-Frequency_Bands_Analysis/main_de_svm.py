...
band_names = {None: '0_None', 0: '1_Delta', 1: '2_Theta', 2: '3_Alpha', 3: '4_Beta', 4: '5_Gamma'}
if remove_band in band_names:
    result_subdir = os.path.join('result', band_names[remove_band])
else:
    result_subdir = os.path.join('result', '0_None')  # fallback to None case
